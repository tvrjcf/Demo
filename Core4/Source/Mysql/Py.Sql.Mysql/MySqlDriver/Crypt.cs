...
*/
                                        ...
                                        byte[] password, int length)
        {
            ...
            if (fromIndex < 0 || fromIndex >= from.Length)
                throw new ArgumentException(System.Data.MySqlClient.Properties.Resources.IndexMustBeValid, "fromIndex");
            if ((fromIndex + length) > from.Length)
                throw new ArgumentException(System.Data.MySqlClient.Properties.Resources.FromAndLengthTooBig, "fromIndex");
            if (from == null)
                throw new ArgumentException(System.Data.MySqlClient.Properties.Resources.BufferCannotBeNull, "from");
            if (to == null)
                throw new ArgumentException(System.Data.MySqlClient.Properties.Resources.BufferCannotBeNull, "to");
            if (toIndex < 0 || toIndex >= to.Length)
                throw new ArgumentException(System.Data.MySqlClient.Properties.Resources.IndexMustBeValid, "toIndex");
            if ((toIndex + length) > to.Length)
                throw new ArgumentException(System.Data.MySqlClient.Properties.Resources.IndexAndLengthTooBig, "toIndex");
            if (password == null || password.Length < length)
                throw new ArgumentException(System.Data.MySqlClient.Properties.Resources.PasswordMustHaveLegalChars, "password");
            if (length < 0)
                throw new ArgumentException(System.Data.MySqlClient.Properties.Resources.ParameterCannotBeNegative, "count");
