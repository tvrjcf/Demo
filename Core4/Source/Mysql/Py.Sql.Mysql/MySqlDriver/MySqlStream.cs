...
namespace System.Data.MySqlClient
{
	...
	internal class MySqlStream
	{
		...
		public void LoadPacket()
		{
			try
			{
				...
				if (b1 == -1 || b2 == -1 || b3 == -1 || seqByte == -1)
					throw new MySqlException(
						 System.Data.MySqlClient.Properties.Resources.ConnectionBroken, true, null);
			...
			{
				throw new MySqlException(System.Data.MySqlClient.Properties.Resources.ReadFromStreamFailed, true, ioex);
			}
		}
		...
		public void StartOutput(ulong length, bool resetSequence)
		{
			...
			if (length > 0)
			{
				if (length > maxPacketSize)
					throw new MySqlException(System.Data.MySqlClient.Properties.Resources.QueryTooLarge, (int)MySqlErrorCode.PacketTooLarge);
				outLength = length;
			}
		...
		public int ReadNBytes()
		{
			...
			if (c < 1 || c > 4)
				throw new MySqlException(System.Data.MySqlClient.Properties.Resources.IncorrectTransmission);
		...
		public void Write(byte[] buffer, int offset, int count)
		{
			...
			while (count > 0)
			{
				...
				{
					throw new MySqlException(System.Data.MySqlClient.Properties.Resources.WriteToStreamFailed, true, ioex);
				}
