...
namespace System.Data.MySqlClient
{
...
#if !CF
	[Editor("System.Data.MySqlClient.Design.DBParametersEditor,MySql.Design", typeof(System.Drawing.Design.UITypeEditor))]
	[ListBindable(true)]
#endif
	public sealed class MySqlParameterCollection : DbParameterCollection
	{
        ...
        /// Adds the with value.
        /// </summary>
        /// <param name="parameterName">要操作的字符串。</param>
        ...
        /// <summary>
        /// 返回集合中指定索引处的 <see cref="T:System.Data.Common.DbParameter"/> 对象。
        /// </summary>
        ...
        /// <summary>
        /// 将具有指定名称的 <see cref="T:System.Data.Common.DbParameter"/> 对象设置为新的值。
        /// </summary>
        ...
        /// <summary>
        /// 将指定索引处的 <see cref="T:System.Data.Common.DbParameter"/> 对象设置为一个新值。
        /// </summary>
        /// <param name="index"><see cref="T:System.Data.Common.DbParameter"/> 对象所处的索引位置。</param>
        /// <param name="value">新 <see cref="T:System.Data.Common.DbParameter"/> 值。</param>
        ...
        private MySqlParameter InternalAdd(MySqlParameter value, int index)
        {
            ...
            if (indexHash.ContainsKey(inComingName))
                throw new MySqlException(
                    String.Format(System.Data.MySqlClient.Properties.Resources.ParameterAlreadyDefined, value.ParameterName));
