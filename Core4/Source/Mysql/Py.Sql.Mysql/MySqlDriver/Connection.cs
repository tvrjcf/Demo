...
namespace System.Data.MySqlClient
{
...
#if !CF
    [ToolboxBitmap(typeof (MySqlConnection), "MySqlClient.System.Data.MySqlClient.Properties.Resources.connection.bmp")]
    ...
    public sealed class MySqlConnection : DbConnection, ICloneable
    {
        ...
        {
            get { return (int) settings.ConnectTimeout; }
        }
        ...
        public override void EnlistTransaction(Transaction transaction)
        {
            ...
            if (driver.CurrentTransaction == null)
            {
                ...
                if (!transaction.EnlistPromotableSinglePhase(t))
                    throw new NotSupportedException(System.Data.MySqlClient.Properties.Resources.DistributedTxnNotSupported);
        ...
        public new MySqlTransaction BeginTransaction(IsolationLevel iso)
        {
            ...
            if (State != ConnectionState.Open)
                throw new InvalidOperationException(System.Data.MySqlClient.Properties.Resources.ConnectionNotOpen);

            // First check to see if we are in a current transaction
            if ((driver.ServerStatus & ServerStatusFlags.InTransaction) != 0)
                throw new InvalidOperationException(System.Data.MySqlClient.Properties.Resources.NoNestedTransactions);
            ...
            switch (iso)
            {
                ...
                case IsolationLevel.Chaos:
                    throw new NotSupportedException(System.Data.MySqlClient.Properties.Resources.ChaosNotSupported);
            }
        ...
        public override void ChangeDatabase(string databaseName)
        {
            if (databaseName == null || databaseName.Trim().Length == 0)
                throw new ArgumentException(System.Data.MySqlClient.Properties.Resources.ParameterIsInvalid, "databaseName");
