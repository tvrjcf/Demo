...
namespace System.Data.Common
{
	...
	internal class NamedPipeStream : Stream
	{
		...
		{
			get { throw new NotSupportedException(System.Data.MySqlClient.Properties.Resources.NamedPipeNoSeek); }
		}
		...
		public override int Read(byte[] buffer, int offset, int count)
		{
			if (buffer == null) 
				throw new ArgumentNullException("buffer", 
					System.Data.MySqlClient.Properties.Resources.BufferCannotBeNull);
			if (buffer.Length < (offset + count))
				throw new ArgumentException(
					System.Data.MySqlClient.Properties.Resources.BufferNotLargeEnough);
			if (offset < 0) 
				throw new ArgumentOutOfRangeException("offset", offset, 
					System.Data.MySqlClient.Properties.Resources.OffsetCannotBeNegative);
			if (count < 0)
				throw new ArgumentOutOfRangeException("count", count, 
					System.Data.MySqlClient.Properties.Resources.CountCannotBeNegative);
			if (! CanRead)
				throw new NotSupportedException(System.Data.MySqlClient.Properties.Resources.StreamNoRead);
			if (pipeHandle == 0) 
				throw new ObjectDisposedException("NamedPipeStream", 
					System.Data.MySqlClient.Properties.Resources.SPNotSupported);
			...
			{
				Close();
				throw new MySqlException(System.Data.MySqlClient.Properties.Resources.ReadFromStreamFailed, true, null);
			}
		...
		{
			throw new NotSupportedException(System.Data.MySqlClient.Properties.Resources.NamedPipeNoSetLength);
		}
		...
		public override void Write(byte[] buffer, int offset, int count)
		{
			...
			if (count < 0)
				throw new ArgumentOutOfRangeException("count", count, 
					System.Data.MySqlClient.Properties.Resources.CountCannotBeNegative);
			if (! CanWrite)
				throw new NotSupportedException(System.Data.MySqlClient.Properties.Resources.StreamNoWrite);
			if (pipeHandle == 0)
				throw new ObjectDisposedException("NamedPipeStream", 
					System.Data.MySqlClient.Properties.Resources.SPNotSupported);
			...
			{
				Close();
				throw new MySqlException(System.Data.MySqlClient.Properties.Resources.WriteToStreamFailed, true, null);
			}
		...
		{
			throw new NotSupportedException(System.Data.MySqlClient.Properties.Resources.NamedPipeNoSeek);
		}
	}
}
