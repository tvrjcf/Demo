...
namespace System.Data.MySqlClient
{
	...
	public class CustomInstaller : Installer
	{
		...
		private static void AddProviderToMachineConfigInDir(string path)
		{
			...
			newNode.SetAttribute("invariant", "System.Data.MySqlClient");
			...
			string type = String.Format("System.Data.MySqlClient.MySqlClientFactory, {0}", a.FullName);
			...
			foreach (XmlNode node in nodes[0].ChildNodes)
			{
                ...
                {
                    if (attr.Name == "invariant" && attr.Value == "System.Data.MySqlClient")
                    {
		...
		public override void Uninstall(System.Collections.IDictionary savedState)
		{
			...
			// installer
			if (!PerformanceCounterCategory.Exists(System.Data.MySqlClient.Properties.Resources.PerfMonCategoryName))
