...
namespace System.Data.MySqlClient
{
...
#if !CF
	[System.Drawing.ToolboxBitmap(typeof(MySqlCommand), "MySqlClient.System.Data.MySqlClient.Properties.Resources.command.bmp")]
	...
	public sealed class MySqlCommand : DbCommand, ICloneable
	{
		...
		[Editor("System.Data.Common.Design.SqlCommandTextEditor,MySqlClient.Design", typeof(System.Drawing.Design.UITypeEditor))]
#endif
        ...
        /// <summary>
        /// 获取或设置是否 <see cref="MySqlCommand"/> 是否取消 。
        /// </summary>
        /// <value>如果取消， 则  true; 否则, false。</value>
		...
		public override void Cancel()
		{
			if (!connection.driver.Version.isAtLeast(5, 0, 0))
				throw new NotSupportedException(System.Data.MySqlClient.Properties.Resources.CancelNotSupported);
        ...
        /// <summary>
        /// 获取或设置此 <see cref="T:System.Data.Common.DbCommand"/> 使用的 <see cref="T:System.Data.Common.DbConnection"/>。
        /// </summary>
        /// <value></value>
        /// <returns>
        /// 与数据源的连接。
        ...
        /// <summary>
        /// 获取 <see cref="T:System.Data.Common.DbParameter"/> 对象的集合。
        /// </summary>
        /// <value></value>
        /// <returns>
        /// SQL 语句或存储过程的参数。
        ...
        /// <value></value>
        /// <returns>
        /// 要在其中执行 .NET Framework 数据提供程序的 Command 对象的事务。默认值为空引用（在 Visual Basic 中为 Nothing）。
        /// </returns>
        ...
        /// 对连接执行命令文本。
        /// </summary>
        /// <param name="behavior"><see cref="T:System.Data.CommandBehavior"/> 的一个实例。</param>
        /// <returns>
