...
namespace System.Data.MySqlClient
{
    ...
    public sealed class MySqlConnectionStringBuilder : DbConnectionStringBuilder
    {
        ...
        /// <summary>
        /// 获取或设置是否将 Tiny 作为 Boolean。
        /// </summary>
        /// <value>如果 true，则自动处理; 否则。</value>
#if !CF && !MONO
        [Category("Advanced")]
        ...
        private static uint ConvertToUInt(object value)
        {
            ...
            {
                throw new ArgumentException(System.Data.MySqlClient.Properties.Resources.ImproperValueFormat, value.ToString());
            }
        }
        ...
        private static bool ConvertToBool(object value)
        {
            if (value is string)
            {
                ...
                throw new ArgumentException(System.Data.MySqlClient.Properties.Resources.ImproperValueFormat, (string) value);
            }
            else
            {
                try
        ...
        private static Keyword GetKey(string key)
        {
            ...
            throw new ArgumentException(System.Data.MySqlClient.Properties.Resources.KeywordNotSupported, key);
        }
        ...
        {
            if (value == null)
                throw new ArgumentException(System.Data.MySqlClient.Properties.Resources.KeywordNoNull, keyword);
            object out_obj;
...
#if !CF
        /// <summary>
        /// 用有关此 <see cref="T:System.Data.Common.DbConnectionStringBuilder"/> 的所有属性的信息填充提供的 <see cref="T:System.Collections.Hashtable"/>。
        /// </summary>
