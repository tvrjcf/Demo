        ...
        public override void Open()
        {
            ...
            try
            {
                ...
                if (Settings.ConnectionProtocol == MySqlConnectionProtocol.SharedMemory)
                {
                    ...
                    str.Open(Settings.ConnectTimeout);
                    baseStream = str;
                }
                else
                {
                    ...
                    baseStream = sc.GetStream(Settings.ConnectTimeout);
#if !CF
                }
#endif
                if (baseStream == null)
            ...
            {
                throw new MySqlException(System.Data.MySqlClient.Properties.Resources.UnableToConnectToHost, 
